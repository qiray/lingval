...
Тут мы наблюдаем, что модель разбиения на предложения, увы, несовершенна, и посчитала несколько предложений за одно. Пришлось отправлять сообщение о баге в NLTK.
...
Средняя длина предложения и и медиана длины меньше, чем у более классических авторов.
...
Радует, что в топ попал массаракш, который вполне ожидаемо был некорректно приведен к нормальной форме. Массаракш!
